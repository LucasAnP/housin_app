...
const style = (colorTheme) => {
  return EStyleSheet.create({
    ...
    modalDescriptionContainer:{backgroundColor:AppStylesHousin.colorSet[colorTheme].cardBackgroundColor, alignSelf:'center',justifyContent:'center', marginTop:AppStylesHousin.WINDOW_HEIGHT * 0.06, borderRadius:10, padding:'5%'}
